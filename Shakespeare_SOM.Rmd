...
```{r}
library("RCurl")
character_table <- read.csv(text=getURL("https://raw.githubusercontent.com/clarkdatalabs/soms/master/Shakespeare_txt/CHAR.csv"), sep=",", header=T, check.names = TRUE, stringsAsFactors = FALSE)
```
